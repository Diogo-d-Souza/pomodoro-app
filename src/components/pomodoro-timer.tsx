...
export default function PomodoroTimer(
  ...
  const [cyclesQtMenager, setCyclesQtMenager] = useState(
  ...
  useEffect(() => {
    ...
    if (working && cyclesQtMenager.length > 0) {
      configureRest(false);
      cyclesQtMenager.pop();
    } else if (working && cyclesQtMenager.length <= 0) {
      configureRest(true);
      setCyclesQtMenager(new Array(props.cycles - 1).fill(true));
